...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-full border border-input bg-background transition-[color,box-shadow] outline-none dark:bg-input/30",
